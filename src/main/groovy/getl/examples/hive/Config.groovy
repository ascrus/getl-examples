...
Create config file in <project path>/tests/hive/hive.conf with syntax:
...
configuration {
    ...
    logConfig "Load configuration hive.conf complete. Use directory \"${configContent.workPath}\"."
}